...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Docyc后台控制', 'optionsframework'),
		'menu_title' => __('Docyc后台控制', 'optionsframework'),
...
if ( ! function_exists( 'docyc_get_option' ) ) {

	function docyc_get_option( $name, $default = false ) {
